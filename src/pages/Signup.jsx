						...
						<form>
							<div className='flex flex-row items-center justify-center lg:justify-start'>
								...
								<button
									...
									data-te-ripple-init
									data-te-ripple-color='light'
									className='inlne-block mx-1 h-9 w-9 rounded-full bg-red-700 uppercase leading-normal shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-red-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]  focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0  active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]'
									onClick={handleLogin}
								>
									{/* <!-- Gmail --> */}
									<svg
